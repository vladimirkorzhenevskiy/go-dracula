...
function activate(context) {
    ...
    function update(editor) {
        ...
        const receiverDecorations = [];
        const yellowDecorations = [];
        const orangeDecorations = [];
        const importDecorations = [];
        const tagKeyDecorations = [];
